...
FIELDS: list[ConfigFieldSpec] = [
    ConfigFieldSpec(
        ...
        label="Plugin root",
        field_type="string",
        description="Directory containing one subdirectory per Skitter plugin.",
    ),
    ConfigFieldSpec(
        key="memory_external_provider",
        path=("memory", "external_provider"),
        category="memory",
        label="External provider",
        field_type="string",
        description="Optional external memory provider id to activate alongside built-in memory.",
    ),
    ConfigFieldSpec(
        key="memory_context_timeout_seconds",
        path=("memory", "context_timeout_seconds"),
        category="memory",
        label="Context timeout seconds",
        field_type="number",
        description="Timeout for automatic memory context providers.",
        minimum=0.1,
        maximum=30,
        step=0.1,
    ),
    ConfigFieldSpec(
        key="memory_recall_timeout_seconds",
        path=("memory", "recall_timeout_seconds"),
        category="memory",
        label="Recall timeout seconds",
        field_type="number",
        description="Timeout for explicit memory recall/search providers.",
        minimum=0.1,
        maximum=120,
        step=0.1,
    ),
    ConfigFieldSpec(
        key="memory_store_timeout_seconds",
        path=("memory", "store_timeout_seconds"),
        category="memory",
        label="Store timeout seconds",
        field_type="number",
        description="Timeout for explicit memory store/forget operations.",
        minimum=0.1,
        maximum=120,
        step=0.1,
    ),
    ...
    ConfigFieldSpec(
        key="executors_request_timeout_seconds",
        path=("executors", "request_timeout_seconds"),
        category="sandbox",
        label="Executor request timeout (sec)",
        field_type="number",
        description="Default timeout for executor tool requests such as shell commands.",
        minimum=10,
        maximum=7200,
        step=10,
    ),
