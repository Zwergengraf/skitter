...
class Session(Base):
    ...
    context_summary_input_tokens: Mapped[int | None] = mapped_column(Integer, nullable=True)
    session_memory_status: Mapped[str | None] = mapped_column(String, nullable=True)
    session_memory_checkpoint: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    session_memory_input_tokens: Mapped[int | None] = mapped_column(Integer, nullable=True)
    session_memory_message_id: Mapped[str | None] = mapped_column(String, nullable=True)
    session_memory_last_error: Mapped[str | None] = mapped_column(Text, nullable=True)
    session_memory_path: Mapped[str | None] = mapped_column(String, nullable=True)
    session_memory_updated_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    summary_status: Mapped[str | None] = mapped_column(String, nullable=True)
    summary_attempts: Mapped[int | None] = mapped_column(Integer, nullable=True)
    summary_next_retry_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
