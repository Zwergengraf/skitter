...
from skittermander.api.app import create_app
from skittermander.api.deps import get_repo
from skittermander.api.routes import commands as commands_routes
...
def test_executor_disable_enable_delete_flow(admin_api_key: str, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("skittermander.tools.executors.node_executor_hub.close_executor", _close_executor)
    monkeypatch.setattr("skittermander.tools.executors.executor_router.clear_session_defaults_for_executor", _clear_defaults)
    monkeypatch.setattr("skittermander.api.routes.executors._running_docker_users", _no_docker_users)
